...
import UIKit
class LookupVaultView: UIViewController {
    ...
    func Deletcard(){
        ...
        """
        print(valtooshow)
        let qucard = LookupCardMessage(soapvalue: valtooshow)
        print(qucard.soapvalue)
        requestTextvw.text = qucard.soapvalue
